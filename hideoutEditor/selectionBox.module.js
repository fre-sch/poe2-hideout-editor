...
class SelectionBox {
   ...
   */
  constructor(camera, scene, layers, deep = Number.MAX_VALUE) {
    /**
  ...
  _searchChildInFrustum (frustum, object) {
    _bbox.setFromObject(object)
    _bbox.getCenter(_center)
    if (frustum.containsPoint(_center) && object.layers.test(this.layerMask)) {
