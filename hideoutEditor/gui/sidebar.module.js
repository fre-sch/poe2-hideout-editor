  ...
  render(
    html`
      ...
      <details class="sidebar-item" open>
        ...
        <ul class="ms-0 ps-3">
        <li>Click and drag <span class="shortcut">left mouse button</span> to select.<br/>
          Hold <span class="shortcut">Shift</span> to add to selection.
          Hold <span class="shortcut">Ctrl</span> to remove from selection.</li>
